class ContractsController < ApplicationController
  ...
  def contract_params
    params.require(:contract).permit(:total_amount, :total_payments, :comments, :client_id, :down_payment, :next_payment, :first_payment, :monthly_payment, :map, :map_date, :signing_date)
  end
end
